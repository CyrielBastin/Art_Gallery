 ...
 */
final class Version20190227231235 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE painting_discount (id INT AUTO_INCREMENT NOT NULL, painting_id INT NOT NULL, discount SMALLINT NOT NULL, UNIQUE INDEX UNIQ_9E7EAC81B00EB939 (painting_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
